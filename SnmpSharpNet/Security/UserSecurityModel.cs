...
namespace SnmpSharpNet
{
    ...
    public class UserSecurityModel : AsnType, ICloneable
    {
        ...
        /// </summary>
        public OctetString AuthenticationParameters { get; private set; }
        ...
        public bool IsAuthentic(MutableByte wholePacket)
        {
            if (_authentication != AuthenticationDigests.None)
            {
                ...
                if (authProto != null)
                {
                    return authProto.AuthenticateIncomingMsg(AuthenticationSecret, _engineId, AuthenticationParameters, wholePacket);
                }
            }
